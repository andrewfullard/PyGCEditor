...
class XMLWriter:
    ...
    def campaignWriter(self, campaign, factions, outputName: str) -> None:
        ...
        for playableFaction in sorted(
            ...
            story_text = self.__story_name_text_for_campaign(campaign)
    ...
    def __story_name_text_for_campaign(self, campaign) -> str:
        """Return story list text, preferring campaign overrides over defaults."""
        if campaign.storyName and campaign.storyName.strip():
            return campaign.storyName
