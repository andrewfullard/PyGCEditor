...
class XMLWriter:
    ...
    def campaignWriter(self, campaign, factions, outputName: str) -> None:
        ...
        for playableFaction in sorted(campaign.playableFactions, key=lambda faction: faction.name):
            ...
            #self.subElementText(campaignElement, "Story_Name", "Rebel, Conquests\Progressive\Story_Plots_Sandbox_Infinities_Rebel.xml,\nEmpire, Conquests\Progressive\Story_Plots_Sandbox_Infinities_Empire.xml,\nUnderworld, Conquests\Progressive\Story_Plots_Sandbox_Infinities_Container.xml")
