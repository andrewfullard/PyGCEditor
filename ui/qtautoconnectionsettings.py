...
class QtAutoConnectionSettings(Dialog):
    ...
    def __init__(self, repository: GameObjectRepository):
        ...
        self.__toggleAutoConnectionVisibility: QCheckBox = QCheckBox(
            "Hide auto planet connections", self.__dialog
        )
        ...
        self.__formLayout.addRow(
            "Max distance for planets to auto-connect:",
            self.__inputAutoConnectionDistance,
        )
    ...
    def show(
        self, currentDistance: int = 0, currentlyVisible: bool = True
    ) -> DialogResult:
    ...
    def __okayClicked(self) -> None:
        ...
        self.__connectionsVisible = (
            not self.__toggleAutoConnectionVisibility.isChecked()
        )
